...
const CACHE_NAME = 'keepvocab-v41';
const ASSETS_TO_CACHE = [
  ...
  './js/services/driveSync.js?v=41',
  './js/services/dictionaryApi.js',
  './js/services/dictionaryApi.js?v=41',
  './js/services/speechService.js',
  './js/services/imageSearch.js',
  './js/services/imageSearch.js?v=41',
  './js/services/exampleSearch.js',
  './js/services/exampleSearch.js?v=41',
  './js/services/syncPolicy.js',
  './js/services/syncPolicy.js?v=41',
  './js/services/srsEngine.js',
  './js/services/srsEngine.js?v=41',
  './js/services/geminiLive.js',
  './js/services/geminiLive.js?v=41',
  './js/components/ReviewView.js',
  './js/components/ReviewView.js?v=41',
  './js/components/LibraryView.js',
  './js/components/LibraryView.js?v=41',
  './js/components/StatsView.js',
  './js/components/StatsView.js?v=41',
  './js/components/PracticeModes.js',
  './js/components/PracticeModes.js?v=41',
  './js/components/VisualMatchMode.js',
  './js/components/VisualMatchMode.js?v=41',
  './js/components/MatchSprintMode.js',
  './js/components/MatchSprintMode.js?v=41',
  './js/components/SpeakingMode.js',
  './js/components/SpeakingMode.js?v=41',
  './js/data/speakingLessons.js',
  './js/data/speakingLessons.js?v=41',
  './js/utils/html.js',
